 ...
 * .read
 */
static ssize_t button1_read( struct file* F, char *buf, size_t count, loff_t *f_pos )
{
...
static ssize_t button2_read( struct file* F, char *buf, size_t count, loff_t *f_pos )
{
	printk(KERN_INFO "button irq counts: %d\n", button_count);
...
static struct file_operations FileOps1 =
{
	.owner        = THIS_MODULE,
	.open         = button_open,
	.read         = button1_read,
...
static struct file_operations FileOps2 =
{
	.owner        = THIS_MODULE,
	.open         = button_open,
	.read         = button2_read,
